 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_exam_feedback']['points']			= array('Punkte', 'Bitte geben Sie die Punktezahl, welche diese Antwort bringt, ein.');
$GLOBALS['TL_LANG']['tl_exam_feedback']['feedback']			= array('Feedback', 'Feedback');
$GLOBALS['TL_LANG']['tl_exam_feedback']['published']		= array('Feedback anzeigen', 'Bei dieser Prüfung Feedback anzeigen.');
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_exam_feedback']['feedback_legend']	= 'Feedback';
$GLOBALS['TL_LANG']['tl_exam_feedback']['publish_legend']	= 'Veröffentlicht';


/**
 * References
 */
$GLOBALS['TL_LANG']['tl_exam_feedback']['rowPoints']		= '%s oder mehr Punkte';
