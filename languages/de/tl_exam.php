...
$GLOBALS['TL_LANG']['tl_exam']['delete']				= array('Prüfung löschen', 'Delete exam ID %s');
$GLOBALS['TL_LANG']['tl_exam']['show']					= array('Prüfungs Details', 'Prüfungsdetails ID %s anzeigen');
